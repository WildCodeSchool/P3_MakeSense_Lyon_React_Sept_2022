...
VALUES (
        'Iris',
        'Tracer',
        'iris.tracer@gmail.com',
        'Teahupo',
        '0606080907',
        'monplusbelavatariris.jpg',
        '12345',
        '1',
        '2022-10-13 12:12:23'
    ), (
        'Madeline',
        'Phara',
        'madeline.phara@gmail.com',
        'Lyon',
        '0606080907',
        'monplusbelavatarmadeline.jpg',
        '12345',
        '1',
        '2022-10-13 12:12:23'
    ), (
        ...
        'Katmandu',
        '0606080907',
        'monplusbelavatarjohn.jpg',
        '$argon2id$v=19$m=65536,t=5,p=1$XVG1HYvyDdoK77LCWWzRfQ$wGbfouh7xFZDafmKjzYGDot2Ms5YAZW9XNiMZsK0KCg',
        '1',
        '2022-10-13 12:12:23'
    ), (
        'Davy',
        'Mccree',
        'davy.mccree@gmail.com',
        'Oslo',
        '0606080907',
        'monplusbelavatardavy.jpg',
        '12345',
        '1',
        '2022-10-13 12:12:23'
    ), (
        ...
        '0606080907',
        'monplusbelavatarjohn.jpg',
        '$argon2id$v=19$m=65536,t=5,p=1$cHKCeWcTAbFAoQip2FBoSQ$YEwzjtbjy/r88czZmo+Ess3AGPYvhonN2HTureWf3NY',
        '1',
        '2022-10-13 12:12:23'
    ), (
        'Morgan',
        'Junkrate',
        'morgan.junkrat@gmail.com',
        'Oslo',
        '0606080907',
        'monplusbelavatardavy.jpg',
        '12345',
...
VALUES (
        ...
        'Acheter un 4X4 pour poluer la planete',
        '<h2 class="ql-align-center"><span style="color: rgb(230, 0, 0);">Lorem ipsum</span></h2><p><span style="color: rgb(0, 138, 0);">dolor sit amet, consectetur </span>adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<span style="color: rgb(153, 51, 255);"> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span></p>',
        '<h2><span style="color: rgb(0, 102, 204);">Lorem ipsum</span></h2><p><span style="background-color: rgb(255, 153, 0); color: rgb(153, 51, 255);">dolor sit amet, consectetur </span>adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<span style="color: rgb(153, 51, 255);"> </span>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deseru<span style="color: rgb(230, 0, 0);">nt mollit anim id est laborum.</span></p>',
        '<h2 class="ql-align-center"><strong style="color: rgb(230, 0, 0); background-color: rgb(255, 255, 204);">Lorem ipsum</strong></h2><p><span style="color: rgb(0, 71, 178);">dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span></p>',
        '<h1 class="ql-align-center"><strong style="color: rgb(153, 51, 255);"><em><u>Lorem ipsum</u></em></strong></h1><p><span style="color: rgb(136, 136, 136);">dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</span><span style="color: rgb(178, 107, 0);"> Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span></p>',
...
INSERT INTO
    message_help (username, email, objet, content)
VALUES (
        'Morgan Junkrate',
        'morgan@gmail.com',
        'Je suis un titre',
...
VALUES (
        ...
        'Je suis un deuxieme commentaire',
        'Pour',
        '2022-11-13 12:12:23',
        '2'
    ), (
        'Je suis un troisieme commentaire',
        'Pour',
        '2023-02-13 12:12:23',
        '3'
    ), (
        'Je suis un quatrieme commentaire',
        'Pour',
        '2022-10-13 12:12:23',
        '4'
    );
...
CREATE TRIGGER ONCOMMENTUPDATE AFTER UPDATE ON COMMENT 
FOR EACH ROW BEGIN 
	IF NEW.vote = 'contre' THEN
	UPDATE decision
	SET
	    status_decision = 'En conflit'
...
CREATE TRIGGER ONCOMMENTINSERT AFTER INSERT ON COMMENT 
FOR EACH ROW BEGIN 
	IF NEW.vote = 'Contre' THEN
	UPDATE decision
	SET

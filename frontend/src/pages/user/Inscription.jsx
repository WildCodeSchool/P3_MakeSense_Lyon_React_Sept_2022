...
function Inscription() {
  ...
  return (
    <div className="inscriptionPage bg-dark-blue md:bg-white relative h-full w-screen sm:overflow-x-hidden ">
      <HeaderCountryChoice />
      <NavLink to="/">
        <img
       ...
       md-max:flex-end"
        >
          ...
          <div className="flex justify-center md:justify-end mx-20">
            <div className="flex md:flex-col flex-row w-[300px] text-center md:rounded-full md:border-2 text-red-pink  justify-around md:justify-start md:mt-20">
